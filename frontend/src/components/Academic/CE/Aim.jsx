  ...
  sections: [
    {
      ...
      content:
        "To be the premier destination for intellectually curious engineers who seek new pathways to make a life-changing impact through inventions and creation of an innovative ecosystem.",
      emoji: "💫",
    },
    {
      id: "mission",
    ...
    },
    {
      ...
      textColor: "text-purple-700",
      listItems: [
        "Develop an educational ecosystem to provide effective teaching-learning through curricular and extracurricular activities.",
        "Transform students into socially aware, globally competent professionals through quality education.",
        "Promote research capabilities with emphasis on modern approaches for academics and research.",
      ],
    },
    {
      id: "peos",
